...
logo_image = customtkinter.CTkImage(Image.open("C:\\Users\\HP\\Desktop\\New folder\\AudioDeepFakeDetection\\images\\ai.png"), size=(64, 64))
...
#     print(f"1. Operation completed\nResult: {result}")

# def my_fun():
#     return input("Enter the path to the audio file: ")
